...
CONTRACTS: dict[Entity, EntityContract] = {
    Entity.ARTICLES: EntityContract(
        ...
        fields=(
            ...
            optional("commercialDescription", TEXT),
            optional("category", TEXT, 2),
            optional("imageUrl", TEXT, 500),
            Field("active", BOOL),
        ...
        destination_mapping={
            ...
            "commercialDescription": "descripcion_comercial",
            "category": "categoria",
            "imageUrl": "imagen_url",
            "active": "activo",
            "brand": "marca",
    ...
    Entity.CUSTOMERS: EntityContract(
        ...
        fields=(
            ...
            optional("sourceCreatedAt", DATETIME),
            optional("sourceUpdatedAt", DATETIME),
        ),
        destination_mapping={
            "name": "nombre",
        ...
        natural_key_candidates=("cod_dap", "ruc"),
    ),
